...
export function LandingPage() {
  ...
  console.log("Welcome to the Permaweb!", "This site is perma-stored on Arweave and https://arweave.net/14uaFhiTDh0gyMS7aL0id8tKCZ93YGiBlLHEvsaaOys is the permanent link to it.");
