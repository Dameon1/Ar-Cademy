...
export default function Profile() {
  ...
  useEffect(() => {
    if (addr) {
      ...
      const fetchData = async () => {
        ...
        console.log(currentBalance, "lets go");
        setBalance(currentBalance);
        console.log(typeof balance, "balance");
      };
      fetchData();
    }
  }, [addr, uploadFileCost, balance]);
  ...
  async function checkUploadCost(bytes) {
    if (bytes) {
      ...
      console.log(cost, typeof cost, "CHECK UPLOAD COST");
...
//           }}>
//             <h4>Step 1</h4>
//             <p className={"labelStyle"}>Preview and Prepare</p>
//             <div className={"inputContainerStyle"}>
//               <input
//                 type="file"
